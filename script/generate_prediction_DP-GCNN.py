...
from Model_DPGCNN import *
from my_util import *


arg = argparse.ArgumentParser()

arg.add_argument('-dataset',type=str, default='lucene', help='software project name (lowercase)')
...
arg.add_argument('-sent_gru_hidden_dim', type=int, default=32, help='sentence attention hidden size') # 64->32
...
arg.add_argument('-target_epochs',type=str,default='25', help='the epoch to load model') #
...
save_model_dir = '../output/model/GCNVul/'
intermediate_output_dir = '../output/intermediate_output/DeepLineDP/within-release/'
prediction_dir = '../output/prediction/DeepLineDP/within-release-GCN/'
