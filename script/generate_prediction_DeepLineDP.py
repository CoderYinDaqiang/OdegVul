...
arg.add_argument('-target_epochs',type=str,default='18', help='the epoch to load model')
...
prediction_dir = '../output/prediction/DeepLineDP/within-release-DeepLineDP/'
        ...
        for filename, df in tqdm(test_df.groupby('filename')):
            ...
            if not os.path.exists(save_file_path):
                with torch.no_grad():
                    ...
                    outputs, word_att_weights, line_att_weight, _ = model(codevec_padded_tensor)
