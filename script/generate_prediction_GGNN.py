...
save_model_dir = '../output/model/GGNNVul/'
intermediate_output_dir = '../output/intermediate_output/DeepLineDP/within-release-GGNN/'
prediction_dir = '../output/prediction/DeepLineDP/within-release-GGNN/'
