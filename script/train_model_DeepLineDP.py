...
arg.add_argument('-num_epochs', type=int, default=40)
arg.add_argument('-embed_dim', type=int, default=50, help='word embedding size')
arg.add_argument('-word_gru_hidden_dim', type=int, default=32, help='word attention hidden size')
arg.add_argument('-sent_gru_hidden_dim', type=int, default=32, help='sentence attention hidden size')
